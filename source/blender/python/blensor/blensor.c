...
PyDoc_STRVAR(M_Blensor_copy_zbuf_doc,
".. function:: copy_zbuf(image)\n"
"   :return: zbuf\n"
"   :rtype: list\n"
);
static PyObject *M_Blensor_copy_zbuf(PyObject *UNUSED(self), PyObject *obj)
{
  PyObject *result;
  float *outbuffer;
  int outbuffer_len;
...
static struct PyMethodDef M_Blensor_methods[] = {
	...
	{"copy_zbuf", (PyCFunction) M_Blensor_copy_zbuf, METH_O, M_Blensor_copy_zbuf_doc},
	{NULL, NULL, 0, NULL}
};
